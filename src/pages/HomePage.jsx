  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-6xl">
        <div className="mx-auto max-w-3xl rounded-2xl bg-white/90 p-6 shadow-sm backdrop-blur-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-md sm:p-10">
          ...
          <div className="mx-auto mt-5 h-1.5 w-20 rounded-full bg-slate-300" />
          ...
          <div className="mt-8 flex justify-center">
            <Link
              to="/onboarding"
              className="rounded-xl bg-slate-900 px-5 py-3 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:-translate-y-1 hover:bg-slate-700 hover:shadow-md"
            >
              Learn How It Works
            </Link>
          </div>
